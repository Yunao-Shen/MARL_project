...
public class HideAgentwAIChaser : Agent
{
    ...
    private ChaserAgentAI hideChaser;
    ...
    private void Start()
    {
        ...
        hideChaser = chaser.GetComponent<ChaserAgentAI>();
    ...
    void UpdateGUI()
    {
        ...
        scoreText.text = "Score: " + hideChaser.totalReward.ToString("F3");
        if (trainChaser == true)
        {
